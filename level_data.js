function load_level(){
	switch(level){
		case 0:
			...
			enemies[enemies.length] = {x: 275, y: 50, w: 20, dx: -2, dy: 0, t: 0, speed: 3, color: "#22ff22",
				x_upper_limit: 400, x_lower_limit: 150, y_upper_limit: 500, y_lower_limit: 0};
			enemies[enemies.length] = {x: 125, y: 50, w: 20, dx: 2, dy: 0, t: 0, speed: 3, color: "#22ff22",
				x_upper_limit: 250, x_lower_limit: 0, y_upper_limit: 500, y_lower_limit: 0};
			enemies[enemies.length] = {x: 250, y: 75, w: 20, dx: -1, dy: 0, t: 0, speed: 4, color: "#22ff22",
				x_upper_limit: 400, x_lower_limit: 150, y_upper_limit: 500, y_lower_limit: 0};
			enemies[enemies.length] = {x: 150, y: 75, w: 20, dx: 1, dy: 0, t: 0, speed: 4, color: "#22ff22",
				x_upper_limit: 250, x_lower_limit: 0, y_upper_limit: 500, y_lower_limit: 0};
			level_text = "1-2";
			break
		case 1:
